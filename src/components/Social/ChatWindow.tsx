...
const ChatWindow: React.FC<ChatWindowProps> = ({ chatUserId, onClose, onStartCall }) => {
  ...
  const { messages, loading, typing, onlineUsers, sendMessage, sendTypingIndicator } = useRealTimeMessages(chatUserId);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-2xl h-[600px] flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {onlineUsers.has(chatUserId) ? 'Online' : 'Offline'}
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {/* Typing indicator */}
          {Object.values(typing).some(isTyping => isTyping) && (
